export const academyData = {
  version: "2026.07.14-next-foundation",
  ...
  backend: {
    ...
    providers: {
      localStorage: {
        ...
        status: "active",
        purpose: "Offline progress, profile draft, payment status draft, and dashboard preferences."
      },
      googleAppsScript: {
        ...
        purpose: "Registration, payment proof, quiz scoring, Sheets, Drive, and email automation."
      },
      supabase: {
        label: "Supabase",
        status: "reserved",
  ...
  announcements: [
    ...
    },
    {
      ...
      label: "Student App",
      title: "Dashboard progress saves on this device.",
      detail: "Completed modules remain available locally even before a paid backend is added."
    }
  ],
  modules: [
    {
